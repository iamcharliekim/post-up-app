            ...
            <section className={styles["section-1"]}>
              <div className={styles["section-1-hero-div"]}>
                <div className={styles["section-1-hero-text"]}>
                  ...
                  <span>
                    The Post-Up App makes it easier than ever to find and run
                    pickup basketball games in your area
                  </span>
              ...
              <div className={styles["cards-wrapper"]}>
                <div className={styles["section-2-card"]}>
                  ...
                  <p className={styles["card-text-sub"]}>
                    Meet and chat with new players in your area using the game's
                    commentboard
                  </p>
                </div>
                ...
                <div className={styles["section-2-card"]}>
                  <div className={styles["players-icon"]}>
                    <FontAwesomeIcon
                      icon={faMapMarkerAlt}
                      className={styles["ball-icon"]}
                    />
                    <FontAwesomeIcon
                      icon={faBasketballBall}
                      className={styles["ball-pin"]}
                    />
                  </div>
                  <div className={styles["card-text-wrapper"]}>
                  ...
                  <p className={styles["card-text-sub"]}>
                    Post-Up will automatically search for games near your
                    location
                  </p>
                </div>
